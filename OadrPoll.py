...
async def async_handler(event):
    print('====================================================')
    print('We received oadrPoll from VEN')
    print(event['body'])
	...
	<oadr:oadrSignedObject>
		<oadr:oadrDistributeEvent ei:schemaVersion="2.0b">
			...
			<oadr:oadrEvent>
				<ei:eiEvent>
					<ei:eventDescriptor>
						<ei:eventID>Event_939393</ei:eventID>
						<ei:modificationNumber>1</ei:modificationNumber>
						<ei:modificationDateTime>2001-12-17T09:30:47Z</ei:modificationDateTime>
						<ei:modificationReason>Update</ei:modificationReason>
						...
						<ei:vtnComment>Sample Payload</ei:vtnComment>
					</ei:eventDescriptor>
					<ei:eiActivePeriod>
						<xcal:properties>
							<xcal:dtstart>
								<xcal:date-time>2001-12-17T09:40:47Z</xcal:date-time>
							</xcal:dtstart>
							<xcal:duration>
							...
							<xcal:tolerance>
								<xcal:tolerate>
									<xcal:startafter>PT3M</xcal:startafter>
								</xcal:tolerate>
							</xcal:tolerance>
							<ei:x-eiNotification>
						...
						<ei:eiEventSignal>
							...
							<ei:eiTarget>
								<power:endDeviceAsset>
									<power:mrid>Exterior_Lighting</power:mrid>
								</power:endDeviceAsset>
							</ei:eiTarget>
						...
						<ei:eiEventBaseline>
							...
							<strm:intervals>
								<ei:interval>
									...
									<ei:signalPayload>
										<ei:payloadFloat>
											<ei:value>25</ei:value>
										</ei:payloadFloat>
									</ei:signalPayload>
								</ei:interval>
							</strm:intervals>
							<ei:baselineID>Deployment_Specific</ei:baselineID>
							<ei:resourceID>RES_1234</ei:resourceID>
							<ei:baselineName>Power Usage</ei:baselineName>
							<power:powerReal>
								<power:itemDescription>RealPower</power:itemDescription>
								<power:itemUnits>W</power:itemUnits>
								<scale:siScaleCode>d</scale:siScaleCode>
					...
					<ei:eiTarget>
						<emix:serviceArea>
							<gml:FeatureCollection gml:id="ID_3">
								<gml:location>
									<gml:Polygon gml:id="ID_4">
										<gml:exterior>
											<gml:LinearRing>
						...
						<ei:resourceID>RES_123</ei:resourceID>
					</ei:eiTarget>
				</ei:eiEvent>
